...
namespace PolynomLib
{
    public class Polynom
    {
        ...
        public override string ToString()
        {
            ...
            {
                if (i == 0) builder.AppendLine((Coefs[i] >= 0 ? "+" : "") + Coefs[i].ToString("0.00"));
                else if (i == 1) builder.AppendLine((Coefs[i] >= 0 ? "+" : "") + Coefs[i].ToString("0.00") + "x");
                else if (i == Coefs.Length - 1) builder.AppendLine(Coefs[i].ToString("0.00") + "x^" + i.ToString());
                else builder.AppendLine((Coefs[i] >= 0 ? "+" : "") + Coefs[i].ToString("0.00") + "x^" + i.ToString());
            }
